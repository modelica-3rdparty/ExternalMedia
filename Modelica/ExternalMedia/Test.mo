package Test 
  package TestMedium "Test cases for TestMedium" 
    ...
    model TestBasePropertiesExplicit 
      ...
      replaceable package Medium = Media.TestMedium;
      CompleteBaseProperties medium1(
                                 redeclare package Medium = Medium) 
        "Constant pressure, varying enthalpy";
      CompleteBaseProperties medium2(
                                 redeclare package Medium = Medium) 
  ...
  package FluidProp "Test cases for FluidPropMedium" 
    ...
    partial package BaseModels "Base models for FluidProp media tests" 
    ...
    package IF95 "Test suite for the FluidProp-Refprop IF95 medium model" 
      model TestStatesSat 
        ...
        BaseModels.CompleteThermodynamicState completeState1(redeclare package 
            Medium = 
              Medium, state=state1);
        BaseModels.CompleteThermodynamicState completeState2(redeclare package 
            Medium = 
              Medium, state=state2);
        BaseModels.CompleteSaturationProperties completeSat1(redeclare package 
            Medium = 
              Medium, sat=sat1);
        BaseModels.CompleteSaturationProperties completeSat2(redeclare package 
            Medium = 
              Medium, sat=sat2);
        BaseModels.CompleteBubbleDewStates completeBubbleDewStates1(redeclare 
            package Medium = 
                     Medium, sat=sat1);
        BaseModels.CompleteBubbleDewStates completeBubbleDewStates2(redeclare 
            package Medium = 
                     Medium, sat=sat1);
      equation 
        baseProperties1.p = 1e5+1e5*time;
      ...
      model TestBasePropertiesExplicit 
        ...
        BaseModels.CompleteBaseProperties medium1(
                                   redeclare package Medium = Medium) 
          "Constant pressure, varying enthalpy";
        BaseModels.CompleteBaseProperties medium2(
                                   redeclare package Medium = Medium) 
          "Varying pressure, constant enthalpy";
      equation 
        medium1.baseProperties.p = 1e5+1e5*time;
