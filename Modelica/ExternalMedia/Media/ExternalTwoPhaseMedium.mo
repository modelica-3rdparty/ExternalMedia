package ExternalTwoPhaseMedium 
  ...
  external "C" uniqueID=  createMedium_(mediumName, libraryName, substanceName, oldUniqueID) 
    annotation(Include="#include \"externaltwophasemedium.h\"", Library="ExternalMediaLib");
  end createMedium;
  ...
  external "C" p=  pressure_(state.uniqueID, inputChoice, state.d, state.h, state.p, state.s, state.T, state.phase,
                            mediumName, libraryName, substanceName) 
    annotation(Include="#include \"externaltwophasemedium.h\"", Library="ExternalMediaLib");
  end pressure;
  
  redeclare replaceable function extends specificEnthalpy 
  external "C" h=  specificEnthalpy_(state.uniqueID, inputChoice, state.d, state.h, state.p, state.s, state.T, state.phase,
                            mediumName, libraryName, substanceName) 
    annotation(Include="#include \"externaltwophasemedium.h\"", Library="ExternalMediaLib");
  end specificEnthalpy;
  
  redeclare replaceable function extends specificEntropy 
    external "C" s=  specificEntropy_(state.uniqueID, inputChoice, state.d, state.h, state.p, state.s, state.T, state.phase,
                            mediumName, libraryName, substanceName) 
    annotation(Include="#include \"externaltwophasemedium.h\"", Library="ExternalMediaLib");
  end specificEntropy;
  
  redeclare replaceable function extends temperature 
  external "C" T=  temperature_(state.uniqueID, inputChoice, state.d, state.h, state.p, state.s, state.T, state.phase,
                            mediumName, libraryName, substanceName) 
    annotation(Include="#include \"externaltwophasemedium.h\"", Library="ExternalMediaLib");
  end temperature;
  
  redeclare replaceable function extends isentropicEnthalpy 
  external "C" h_is=  isentropicEnthalpy_(p_downstream, refState.uniqueID, inputChoice, refState.d, refState.h, refState.p, refState.s, refState.T, refState.phase,
                                          mediumName, libraryName, substanceName) 
    annotation(Include="#include \"externaltwophasemedium.h\"", Library="ExternalMediaLib");
  end isentropicEnthalpy;
  
  redeclare replaceable function extends isobaricExpansionCoefficient 
  external "C" beta=  isobaricExpansionCoefficient_(state.uniqueID, inputChoice, state.d, state.h, state.p, state.s, state.T, state.phase,
                                                    mediumName, libraryName, substanceName) 
    annotation(Include="#include \"externaltwophasemedium.h\"", Library="ExternalMediaLib");
  end isobaricExpansionCoefficient;
  
  redeclare replaceable function extends isothermalCompressibility 
  external "C" kappa=  isothermalCompressibility_(state.uniqueID, inputChoice, state.d, state.h, state.p, state.s, state.T, state.phase,
                            mediumName, libraryName, substanceName) 
    annotation(Include="#include \"externaltwophasemedium.h\"", Library="ExternalMediaLib");
  end isothermalCompressibility;
  
  redeclare replaceable function extends specificHeatCapacityCp 
  external "C" cp=  specificHeatCapacityCp_(state.uniqueID, inputChoice, state.d, state.h, state.p, state.s, state.T, state.phase,
                            mediumName, libraryName, substanceName) 
    annotation(Include="#include \"externaltwophasemedium.h\"", Library="ExternalMediaLib");
  end specificHeatCapacityCp;
  
  redeclare replaceable function extends specificHeatCapacityCv 
  external "C" cv=  specificHeatCapacityCv_(state.uniqueID, inputChoice, state.d, state.h, state.p, state.s, state.T, state.phase,
                            mediumName, libraryName, substanceName) 
    annotation(Include="#include \"externaltwophasemedium.h\"", Library="ExternalMediaLib");
  end specificHeatCapacityCv;
  
  redeclare replaceable function extends density_derp_h 
  external "C" ddph=  density_derp_h_(state.uniqueID, inputChoice, state.d, state.h, state.p, state.s, state.T, state.phase,
                            mediumName, libraryName, substanceName) 
    annotation(Include="#include \"externaltwophasemedium.h\"", Library="ExternalMediaLib");
  end density_derp_h;
  
  redeclare replaceable function extends density_derh_p 
    external "C" ddhp=  density_derh_p_(state.uniqueID, inputChoice, state.d, state.h, state.p, state.s, state.T, state.phase,
                            mediumName, libraryName, substanceName) 
    annotation(Include="#include \"externaltwophasemedium.h\"", Library="ExternalMediaLib");
  end density_derh_p;
  ...
  external "C" dTp=  saturationTemperature_derp_sat_(sat.psat, sat.Tsat, sat.uniqueID, mediumName, libraryName, substanceName) annotation(Include="#include \"externaltwophasemedium.h\"", Library="ExternalMediaLib");
