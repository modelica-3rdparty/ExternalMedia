...
<p>Main contributors: Francesco Casella, Christoph Richter, Roberto Bonifetto, Ian Bell, Jorrit Wronski.</p>
...
<p>Copyright &copy; 2006-2022, Francesco Casella, Christoph Richter, Roberto Bonifetto, Ian Bell, Jorrit Wronski, Federico Terraneo.</p>
</html>"));
end ExternalMedia;
